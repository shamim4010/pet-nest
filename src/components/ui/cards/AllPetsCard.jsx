        ...
        <div className="group relative w-[320px] overflow-hidden rounded-[26px] border border-[#22c55e]/10 bg-[#07130d]/80 backdrop-blur-2xl transition-all duration-500 hover:-translate-y-2 hover:border-[#4ade80]/40 hover:shadow-[0_20px_60px_rgba(34,197,94,0.35)]">
            ...
            <div className="relative h-[420px] overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 z-20 p-5">
                    ...
                    <Link href={`/pets/${pet.id}`} className="relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-[#16a34a] via-[#22c55e] to-[#4ade80] py-3 text-sm font-bold tracking-wide text-white transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_10px_35px_rgba(34,197,94,0.45)] active:scale-[0.98]">
